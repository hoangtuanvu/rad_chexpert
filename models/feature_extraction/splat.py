...
class SplAtConv2d(Module):
    ...
    def __init__(self, in_channels, channels, kernel_size, stride=(1, 1), padding=(0, 0),
                 dilation=(1, 1), groups=1, bias=True, radix=2, reduction_factor=4, rectify=False,
                 rectify_avg=False, norm_layer=None, dropblock_prob=0.0, **kwargs):
        ...
        if self.rectify:
            ...
            self.conv = RFConv2d(in_channels, channels * radix, kernel_size, stride, padding,
