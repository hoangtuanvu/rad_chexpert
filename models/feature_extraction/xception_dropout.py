...
from models.utils import DropBlock2D, LinearScheduler
...
def xception_dropout(cfg, **kwargs):
    model = Xception_drop(**kwargs)
    if cfg.pretrained:
...
# class ATXception(nn.Module):
#     def __init__(self, num_classes, pretrained, attention_type):
#         super(ATXception, self).__init__()
#         self.xception = xception_drop(pretrained=pretrained)
