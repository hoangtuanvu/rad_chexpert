...
from models.feature_extraction.resnet import ResNet, Bottleneck, resnet18, resnet50
...
def resnet18_ssl(cfg, progress=True, **kwargs):
    ...
    """
    return _resnet(semi_supervised_model_urls['resnet18'], 18, cfg.pretrained, progress, **kwargs)


def resnet50_ssl(cfg, progress=True, **kwargs):
    """Constructs a semi-supervised ResNet-50 model pre-trained on YFCC100M dataset and finetuned on ImageNet
    `"Billion-scale Semi-Supervised Learning for Image Classification" <https://arxiv.org/abs/1905.00546>`_
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(semi_supervised_model_urls['resnet50'], 50, cfg.pretrained, progress, **kwargs)


def resnext50_32x4d_ssl(cfg, progress=True, **kwargs):
    ...
    return _resnext(semi_supervised_model_urls['resnext50_32x4d'], Bottleneck, [3, 4, 6, 3],
                    cfg.pretrained, progress, **kwargs)


def resnext101_32x4d_ssl(cfg, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnext(semi_supervised_model_urls['resnext101_32x4d'], Bottleneck, [3, 4, 23, 3],
                    cfg.pretrained, progress, **kwargs)


def resnext101_32x8d_ssl(cfg, progress=True, **kwargs):
    ...
    return _resnext(semi_supervised_model_urls['resnext101_32x8d'], Bottleneck, [3, 4, 23, 3],
                    cfg.pretrained, progress, **kwargs)

from torchvision.models import resnet

def resnext101_32x16d_ssl(cfg, progress=True, **kwargs):
    ...
    return _resnext(semi_supervised_model_urls['resnext101_32x16d'], Bottleneck, [3, 4, 23, 3],
                    cfg.pretrained, progress, **kwargs)


# -------------- semi-weakly supervised models ----------------
def resnet18_swsl(cfg, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr.
    """
    return _resnet(semi_weakly_supervised_model_urls['resnet18'], 18, cfg.pretrained, progress,
                   **kwargs)


def resnet50_swsl(cfg, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(semi_weakly_supervised_model_urls['resnet50'], 50, cfg.pretrained, progress,
                   **kwargs)


def resnext50_32x4d_swsl(cfg, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnext(semi_weakly_supervised_model_urls['resnext50_32x4d'], Bottleneck, [3, 4, 6, 3],
                    cfg.pretrained, progress, **kwargs)


def resnext101_32x4d_swsl(cfg, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnext(semi_weakly_supervised_model_urls['resnext101_32x4d'], Bottleneck,
                    [3, 4, 23, 3], cfg.pretrained, progress, **kwargs)


def resnext101_32x8d_swsl(cfg, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 8
    return _resnext(semi_weakly_supervised_model_urls['resnext101_32x8d'], Bottleneck,
                    [3, 4, 23, 3], cfg.pretrained, progress, **kwargs)
